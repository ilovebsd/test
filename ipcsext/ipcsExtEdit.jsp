...
try{	
	...
	String sql = "Select deptid, deptname, parentid From table_dept Where deptid <> parentid AND checkgroupid='"+checkgroupid+"' ORDER BY deptid";
	ResultSet rs = null;
	try {
	    if (stmt != null) {
	...
	//********** positionList ***********//
	List 		positionList 	= null;//commonData.getPositionList(stmt);	// 직급 데이타 조회
	PositionDTO 		positionDTO;
	positionList 	= new ArrayList<PositionDTO>();
	sql = "Select positionid, positionname From table_position WHERE checkgroupid = '"+checkgroupid+"' Order By ranking";
...
<input type='hidden' name ='txtId'			value="<%=endPointID%>">
<input type='hidden' name ='txtPass'		value="">
<input type='hidden' name ='position'		value="<%=checkgroupid%>">
<input type='hidden' name ='dept'			value="<%=nDeptId+"|"+nDeptParentId%>">
<input type='hidden' name ='txtMobile'		value="">
<input type='hidden' name ='txtHomeNumber'	value="">
<input type='hidden' name ='txtMail'		value="">
...
<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  ...
  <tr>
    ...
    <td width="69" align="right" bgcolor="#FFFFFF" style="padding-right:5 "> <strong>전화번호 </strong></td>
    <td width="106" bgcolor="#FFFFFF" style="padding-right:5 "><input type="text" name="txtName" style="width:100px" value="<%=ei64%>" disabled></td>
  ...
  <tr>
    ...
    <td width="106" bgcolor="#FFFFFF" style="padding-right:5 ">
    	<%if(userCount>0){%>
    		<%if(routeCount>0){%>
    			<input name="txtExtension" type="text" id="inside" style="width:100" value="<%=ipcsDetailDTO.getExtension()%>" maxlength="4" onkeydown="return onlyNumber(event);"></td><td colspan="2" bgcolor="#FFFFFF">&nbsp;
    		<%}else{%>
    			<input name="txtExtension" type="text" id="inside" style="width:100" value="<%=ipcsDetailDTO.getExtension()%>" maxlength="4" onkeydown="return onlyNumber(event);" disabled></td><td colspan="2" bgcolor="#FFFFFF">&nbsp;
    		<%}%>		
    	<%}else{%>
    		<%if(routeCount>0){%>
    			<input name="txtExtension" type="text" id="inside" style="width:100" value="<%=tempExtension%>" maxlength="4" onkeydown="return onlyNumber(event);"></td><td colspan="2" bgcolor="#FFFFFF">&nbsp;
    		<%}else{%>
    			<input name="txtExtension" type="text" id="inside" style="width:100" value="<%=tempExtension%>" maxlength="4" onkeydown="return onlyNumber(event);" disabled></td><td colspan="2" bgcolor="#FFFFFF">&nbsp;
    		<%}%>
    	<%}%>
    </td>
    <td width="10">&nbsp;</td>
 ...
 <%--  <tr>
  ...
  <tr align="center">
    <td height="35" colspan="6" style="padding-top:3 "><a href="#" onclick="javascript:goEditSave();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=StaticString.ContextRoot%>/imgs/Content_save_p_btn.gif',0)"> <img src="<%=StaticString.ContextRoot%>/imgs/Content_save_n_btn.gif" name="Image3" width="40" height="20" border="0"></a> <a href="#" onclick="javascript:hiddenAdCodeDiv();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4','','<%=StaticString.ContextRoot%>/imgs/Content_cancel_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_cancel_n_btn.gif" name="Image4" width="40" height="20" border="0"></a></td>
  </tr>
</table>
</div>

<div id="menu2" style="display:;" >	
<%if(userCount>0){%>
	<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
	  <tr>
	    <td height="30" colspan="4" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> <strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">개인내선번호 수정 </strong></td>
	  ...
	  <%if(auth_MD5==0){%>
		  ...
		  <tr>
		    ...
		    <td colspan="2" bgcolor="#FFFFFF"><input name="txtid" type="text" id="id" value="<%=ipcsDetailDTO.getUsername()%>" style="width:120 "  maxlength="32" disabled></td>
		    <td width="10">&nbsp;</td>
		  </tr>
		  <tr>
		    <td width="10" height="30">&nbsp;</td>
		    ...
		    <td colspan="2" bgcolor="#FFFFFF"><input name="txtpassword" type="password" id="pass" value="<%=ipcsDetailDTO.getPassword()%>" style="width:120;height:14px;font-size:7px; ime-mode:inactive;"  maxlength="32" disabled></td>
		    <td width="10">&nbsp;</td>
		  </tr>
		  <tr>
		    <td width="10" height="30">&nbsp;</td>
		    ...
		    <td colspan="2" bgcolor="#FFFFFF"><input name="txtpass_chk" type="password" id="pass" value="<%=ipcsDetailDTO.getPassword()%>" style="width:120;height:14px;font-size:7px; ime-mode:inactive;"  maxlength="32" disabled></td>
		    <td width="10">&nbsp;</td>
		  </tr>
		  <tr>
		    <td width="10" height="30">&nbsp;</td>
	  ...
	  <tr>
	    ...
	    <td colspan="3" bgcolor="#FFFFFF">
	    	<input type="text" name="txtZone" value="<%=Str.CheckNullString(ipcsDetailDTO.getZonecode())%>" style="width:90px;" disabled>
...
<%}else{%>
	<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
	  ...
	  <tr>
	    <td width="10" height="30">&nbsp;</td>
	    <td width="69px" align="right" bgcolor="#FFFFFF" style="padding-right:5 "> <strong>Zone</strong></td>
	    <td colspan="3" bgcolor="#FFFFFF">
	    	<input type="text" name="txtZone" style="width: 90px;" disabled>
	    	<a href="javascript:goZone_Edit('U');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image77','','<%=StaticString.ContextRoot%>/imgs/Content_search_p_btn.gif',1)">
	    		<img src="<%=StaticString.ContextRoot%>/imgs/Content_search_n_btn.gif" name="Image77" width="40px" height="20" border="0" align="absmiddle" id="Image7" />
	    	</a>
	    	&nbsp;&nbsp;ZONE 사용	
	    	<select name="zoneChk" style="width:75px;height:15; font-size:12px; " onChange="javascript:selectZone_Edit()">
	  ...
	  <tr align="center">
	    <td height="35" colspan="6" style="padding-top:3 ">
	    	<a href="#" onclick="javascript:goEditSave();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=StaticString.ContextRoot%>/imgs/Content_save_p_btn.gif',0)"> <img src="<%=StaticString.ContextRoot%>/imgs/Content_save_n_btn.gif" name="Image3" width="40" height="20" border="0"></a> 
