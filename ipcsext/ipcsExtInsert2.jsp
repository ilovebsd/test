...
String 	passwd		= new String(request.getParameter("hiPasswd").getBytes("8859_1"), "euc-kr");		// 인증 암호
...
<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  ...
  <tr>
    ...
    <td width="106" bgcolor="#FFFFFF" style="padding-right:5 "><input type="text" name="txtName" style="width:100" value="<%=ei64/* endPointID */%>" disabled></td>
...
<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  ...
  <tr>
    ...
    <td colspan="2" bgcolor="#FFFFFF"><input name="txtpassword" type="password" id="pass" value="<%=passwd%>" style="width:120 "  maxlength="32"></td>
    <td width="10">&nbsp;</td>
  </tr>
  <tr>
    <td width="10" height="30">&nbsp;</td>
...
-->
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#FFFFFF">
    	...
    	<a href="javascript:goZone('I');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image77','','<%=StaticString.ContextRoot%>/imgs/Content_search_p_btn.gif',1)">
    	...
    	&nbsp;&nbsp;ZONE 사용
    	<select name="zoneChk" style="width:75px;height:15; font-size:12px; " onChange="javascript:selectZone()">
  ...
  <tr align="center">
    <td height="35" colspan="6" style="padding-top:3 ">
    	<a href="#" onclick="javascript:goUserBefore();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image2','','<%=StaticString.ContextRoot%>/imgs/Content_before_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_before_n_btn.gif" name="Image2" width="40" height="20" border="0"></a> 
    	<a href="#" onclick="javascript:goNewSave();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=StaticString.ContextRoot%>/imgs/Content_next_p_btn.gif',0)"> <img src="<%=StaticString.ContextRoot%>/imgs/Content_next_n_btn.gif" name="Image3" width="40" height="20" border="0"></a> 
