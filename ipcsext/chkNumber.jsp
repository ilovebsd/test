...
<%
	try{
		String 		req_EndPointId 	= Str.CheckNullString(request.getParameter("fullEndPointId")).trim();
		String 		req_Ei64 		= Str.CheckNullString(request.getParameter("hiEi64")).trim();		
		ResultSet	rs 				= null;
		String		sql				= "";		
		int 		cnt				= 0;
		int 		cnt2			= 0;
