...
<input type='hidden' name ='hiEi64' 			value="<%=ei64%>">
	...
	<table width="307" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	  ...
	  <tr align="center">
	    <td colspan="4"><a href="#" onclick="javascript:goDeletePro();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3999','','<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" name="Image3999" width="40" height="20" border="0"></a>&nbsp;<a href="#" onclick="javascript:hiddenAdCodeDiv();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image4999','','<%=StaticString.ContextRoot%>/imgs/Content_cancel_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_cancel_n_btn.gif" name="Image4999" width="40" height="20" border="0"></a></td>
	  </tr>
	  <tr align="center">
	    <td colspan="4">&nbsp;</td>
	  </tr>
