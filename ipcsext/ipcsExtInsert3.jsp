...
//String 	name		= new String(request.getParameter("hiName").getBytes("8859_1"), "euc-kr");			// 이름
//String 	position	= new String(request.getParameter("hiPosition").getBytes("8859_1"), "euc-kr");		// 직급
//String 	dept		= new String(request.getParameter("hiDept").getBytes("8859_1"), "euc-kr");			// 부서
String 	name		= new String(request.getParameter("hiName").getBytes("8859_1"), "utf-8");			// 이름
String 	position	= new String(request.getParameter("hiPosition").getBytes("8859_1"), "utf-8");		// 직급
String 	tempDept		= new String(request.getParameter("hiDept").getBytes("8859_1"), "utf-8");			// 부서
String 	extension	= request.getParameter("hiExtension");		// 내선번호

String[]	tempStr = tempDept.split("[|]");
String 		deptNo		= tempStr[0];
//String 		parentID	= tempStr[1];

//서버로부터 DataStatement 객체를 할당
//DataStatement 	stmt 		= ConnectionManager.allocStatement("SSW");
CommonData		commonData	= new CommonData();
//String			deptName	= commonData.deptName(stmt, deptNo);			// 부서명 조회
String			deptName	= commonData.deptName2(deptNo);			// 부서명 조회
//할당받은 DataStatement 객체는 반납
//if (stmt != null) ConnectionManager.freeStatement(stmt);

//System.out.println("프로그램 로그_02 : 4444444");
//System.out.println("내선번호 : "+extension);
%>
...
<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  ...
  <tr>
    <td width="4" height="30">&nbsp;</td>
    <td width="90" align="right" bgcolor="#FFFFFF" style="padding-right:5 "><div align="right"><strong>이름 :</strong></div></td>
    <td colspan="3" bgcolor="#FFFFFF"><input type="text" name="txtName" style="width:150" value="<%=name%>" disabled></td>
    <td width="6">&nbsp;</td>
  </tr>
  <tr>
    <td height="30">&nbsp;</td>
    <td align="right" bgcolor="#FFFFFF" style="padding-right:5 "><div align="right"><strong>직급 :</strong></div></td>
    <td colspan="3" bgcolor="#FFFFFF"><input type="text" name="txtPosition" style="width:150" value="<%=position%>" disabled></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td width="4" height="30">&nbsp;</td>
    <td width="90" align="right" bgcolor="#FFFFFF" style="padding-right:5 "><div align="right"><strong>부서 :</strong></div></td>
    <td colspan="3" bgcolor="#FFFFFF"><input type="text" name="txtDept" style="width:150" value="<%=deptName%>" disabled></td>
    <td width="6">&nbsp;</td>
  </tr>    
  <tr>
    <td width="4" height="30">&nbsp;</td>
  ...
  <tr align="center">
    <td height="35" colspan="6" style="padding-top:3 ">
    	...
    	<a href="#" onclick="javascript:goInsertDone(<%=""%>);" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif',0)"> <img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" name="Image3" width="40" height="20" border="0"></a> 
