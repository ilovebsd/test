...
<form name="Deletelayer1" method="post">
	...
	<table width="307" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	  ...
	  <tr align="center">
	    <td colspan="4"><a href="javascript:hiddenAdCodeDiv();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image33','','<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif',0)">
	     <img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" name="Image33" width="40" height="20" border="0"></a>
	    </td>
	  </tr>
	  <tr align="center">
	    <td colspan="4">&nbsp;</td>
