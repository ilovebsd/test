...
<table width="8100" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td>
	  <table width="810" border="0" cellspacing="0" cellpadding="0" align="center">
	    <tr>
		    <td height="30" colspan="2" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> <strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">착신전환 수정 [<%=e164%>]</strong></td>
		    ...
		    <td style="padding-top:10; padding-bottom:5; background:eeeff0; border-bottom:1 solid #cdcecf; height:325" valign="top">
		      <table width="775" border="0" cellspacing="0" cellpadding="1	" align="left" style="margin:0 0 0 8 ">
		        <tr>
		          ...
		          <div align="center"><a href="javascript:goUpdate_New();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image222','','<%=StaticString.ContextRoot%>/imgs/Content_save_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_save_n_btn.gif" name="Image222" width="40" height="20" border="0"></a> <a href="javascript:hiddenAdCodeDiv2();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image444','','<%=StaticString.ContextRoot%>/imgs/Content_cancel_p_btn.gif',0)"><img src="<%=StaticString.ContextRoot%>/imgs/Content_cancel_n_btn.gif" name="Image444" width="40" height="20" border="0"></a></div></td>
		        </tr>
		      </table>
		    </td>
		  </tr>
