...
int 	tCount2 = 0;
try{
	iList 	= arrivalSwitchList.getDetailList(stmt, e164);		// 데이타 조회
	iCount 	= iList.size();
	
	tCount2 = arrivalSwitchList.getTimeCount(stmt, e164);
...
<table width="400" height="245" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea" >
  <tr>
    ...
    <td align="right" background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"><img src="<%=StaticString.ContextRoot%>/imgs/icon_x.gif" 
    	onClick="hiddenAdCodeDiv3();" style="CURSOR:hand"></td>
  ...
  <tr>
    ...
    <td colspan="2" align="center" bgcolor="#FFFFFF">
        <table width="365" border="0" cellspacing="0" cellpadding="0"  class="list_table">
			...
			<tr bgcolor="#F3F9F5"><td height="5"> </td>
            </tr>
            
            <tr bgcolor="#F3F9F5">
              <td width="365" align="left">
	              	&nbsp;&nbsp;착신전환번호&nbsp;&nbsp;
              		<input type='text' name='txtNumber2' id="txtNumber2" value="" style='width:100; margin:0 0 0 0' maxlength="14">&nbsp;&nbsp;<img src="<%=StaticString.ContextRoot%>/imgs/Content_add_n_btn.gif" 
              			onClick="javascript: goAddPro2();" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_add_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_add_p_btn.gif");' style="CURSOR:hand;" width="40" height="20" align="absmiddle">
              </td>
            </tr>
            ...
            <tr bgcolor="#F3F9F5" align="center" ><td>&nbsp;</td>
            </tr>
        </table>
    </td>
    <td width="7"></td>
  ...
  <tr align="center">
    <td height="35" colspan="4" style="padding-top:3 ">
		<img src="<%=StaticString.ContextRoot%>/imgs/Content_exit_n_btn.gif" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_exit_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_exit_p_btn.gif");' style="CURSOR:hand;" 
			onClick="hiddenAdCodeDiv3();" width="40" height="20">
    </td>
  </tr>
</table>
