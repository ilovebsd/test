	...
	<table width="307" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	  <tr>
        <td colspan="2" height="30" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> 
        	<strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">가상발신번호 삭제</strong>
        </td>
	  ...
	  <tr align="center">
	    ...
	    <td height="25" colspan="2"><B>선택한 가상발신 번호를 삭제</BR>하시겠습니까?</B></td>
	    <td width="8"></td>
	  </tr>
	  <tr>
	    <td colspan="4">&nbsp;</td>
