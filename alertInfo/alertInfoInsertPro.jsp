...
String alertIntoType        = StringUtil.null2Str(request.getParameter("hiAlertIntoType"),"");
    ...
    for(String strE164 : e164s)
    	if( (strE164 = strE164.trim()).length()>0 ){
    		...
    		if(jsArray.length()==0)	jsArray.append("[{params:");
	            	...
	            	sql  = " SELECT count(*) FROM table_featureservice WHERE e164 = '" + strE164 +"' and serviceno = 5451 ";
                    ...
                    if (cnt == 0){
		    			...
		    			sql = sql + "  values('" + strE164 + "', 5451, 5451, '" + alertIntoType + "', 2, 1, 0, 2)";
