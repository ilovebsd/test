...
<%
	...
	String sysgroupid = "";
	try{
		sysgroupname = Str.CheckNullString( request.getParameter("sysgroupname") );
	}catch (Exception e){
		sysgroupid = "";
	}
...
<script language="JavaScript" type="text/JavaScript">
		...
		function onLoginPro(){
            ...
            f.sysgroupname.value = '<%=sysgroupname%>';

		   	f.target = "procframe";
            //f.action = "<%=StaticString.ContextRoot%>/alarm/alarmLoginPro.jsp";
            f.action = "alarmLoginPro.jsp";
            f.method = "post";
            f.submit();	
		}	
			  ...
			  if(_p=document.getElementById("h"+_i+"_0"))
			  {
		  		...
		  		for(var z=0; z<datas.length; z++){
	 				if(datas[z].params[0]==_e164) {
	 					document.getElementById("h"+_i+"_2").innerHTML = datas[z].params[1] ;
		...
		function goDeleteDone(datas){
			...
			while(_o=document.getElementById("g"+_i))
			{
			  ...
			  if(_p=document.getElementById("h"+_i+"_0"))
			  {
		  		...
		  		for(var z=0; z<datas.length; z++){
	 				if(datas[z].params[0]==_e164) {
	 					document.getElementById("h"+_i+"_2").innerHTML = "미등록" ;
...
// 		 	document.cookie = "id_cookie_alarm" + "=";
		 	//document.location.href = "./alarmLogout.jsp";
		 	var f   = document.frm;

		   	f.target = "procframe";
            f.action = "alarmLogout.jsp";
            f.method = "post";
            f.submit();	
...
#menu {
      ...
      position: fixed; top: 5px; z-index: 999;
...
<FORM name="frm" method="post">
	...
	<input type='hidden' name ='sysgroupname' value="">
        ...
        <td valign="bottom">
          <table width="700" border="0" cellspacing="0" cellpadding="0" align="left" bgcolor="ffffff" style="border:1 solid rgb(160,160,160) ">
              <tr align="center" height="22" >
                  ...
                  <td colspan="1" width="100px" style="color: blue;vertical-align: bottom;" ><% if(nAllowUser==1) out.println(authGroupid); %> </td>
...
<%					
	...
	if(nModeDebug!=1){
		...
		// 		String 			strColNames[]	= {"sysgroupid","sysgroupname"};
				...
				//if(sysgroupname.length()>0 && !sesSysGroupID.equals(sysgroupname) ){}
