...
<script language="JavaScript" type="text/JavaScript">
		...
		function goNewSave(){
            ...
            f.alarmdate_3.value = f2.alarmdate_2.value;
		   	...
		   	f.target = "procframe";
            f.action = "<%=StaticString.ContextRoot+pageDir%>/alarm/alarmInsertPro.jsp";
            f.method = "post";
            f.submit();	
		}		
		/**
		...
		function goDeletePro(){
            ...
            f.deleteStr.value = str;//
		   	...
		   	f.target = "procframe";
            f.action = "<%=StaticString.ContextRoot+pageDir%>/alarm/alarmDeletePro.jsp";
            f.method = "post";
            f.submit();	
		}
		...
		// 		String 			strColNames[]	= {"sysgroupid","sysgroupname"};
				...
				if(stmt!=null){
					...
					String 			commonSql		= "SELECT E.e164 e164, extensionnumber, alarmdate, alarmtime " ; 
									...
									commonSql		+= " WHERE e.checkgroupid = '"+authGroupid+"'";
