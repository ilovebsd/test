...
statement.stxTransaction();
    ...
    for(String strE164 : e164s)
    	if( (strE164 = strE164.trim()).length()>0 ){
        	...
        	sql  = "\n SELECT count(*) FROM table_featureservice  WHERE serviceno = 5121 AND e164 = '" + strE164 +"'";
            ...
            if (cnt > 0){
            	sql = " Delete From table_featureservice Where e164  = '" + strE164 + "' And serviceno = 5121 ";
