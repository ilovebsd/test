...
String e164			= new String(request.getParameter("e164"));
...
<input type='hidden' id="e164" name ='e164' 		value="<%=e164%>"/>

<table width="240" height="155" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  <tr>
    <td height="30" colspan="2" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> <strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">인터컴 기능 수정</strong></td>
    ...
    <td colspan="2" align="center" bgcolor="#FFFFFF" valign="top">
        <table width="200" border="0" cellspacing="0" cellpadding="0"  class="list_table">
            ...
            <tr height="22" bgcolor="#F3F9F5">
              <td width="200" align="left">&nbsp;인터컴 수신번호
              	<input type='text' name='txtNumber' id="txtNumber" value="<%=userparam%>" style='width:95; margin:0 0 0 0' maxlength="14">
              </td>
            </tr>
            <tr height="10" bgcolor="#F3F9F5" align="center" ><td></td></tr>
        </table>
  ...
  <tr align="center">
    <td height="35" colspan="4" style="padding-top:3 ">
		<img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" onClick="javascript:goAddPro2();" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif");' style="CURSOR:hand;" width="40" height="20">
