...
<table width="450" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
  <tr>
    <td height="30" colspan="3" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> <strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">Company ID 추가</strong></td>
  ...
  <tr>
    ...
    <td height="35" align="left" valign="middle" bgcolor="#FFFFFF" style="padding-right:5 ">
    	...
    	<input type="button" name="btnchkGroupid" width="100" value="중복체크" onclick="javascript:goNewSaveDupCheck('groupid')">
	</td>
    <td>&nbsp;</td>
  </tr>
  <!-- # Manager Login -->
  ...
  <tr>
    ...
    <td height="35" bgcolor="#FFFFFF" style="padding-right:5 ">
    	...
    	<input type="button" name="btnchkLoginid" width="100" value="중복체크" onclick="javascript:goNewSaveDupCheck('regid')">
    </td>
    <td width="7">&nbsp;</td>
  </tr>
  <!-- Password -->
  ...
  <tr>
    ...
    <td height="35" bgcolor="#FFFFFF" style="padding-right:5 ">
    	...
    	<input type="button" name="btnchkDomain" width="100" value="찾기" onclick="javascript:goDomain('I');"/>
    </td>
    <td width="7">&nbsp;</td>
  </tr>
  <!-- 시작번호 -->
