...
<input type='hidden' name ='hiUserID'			value="<%=userID%>">
	...
	<table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="eaeaea">
	  <tr>
	    <td height="30" colspan="4" style="padding-left:10;padding-top:5 " background="<%=StaticString.ContextRoot%>/imgs/layer_titlebg_img.gif"> <strong style="font-family:굴림체;font-size:10pt; text-decoration:none; color:RGB(255,255,255);">대표번호 수정 </strong></td>
	  ...
	  <tr>
	    ...
	    <td width="109" align="right" bgcolor="#FFFFFF" style="padding-right:5 "> <strong>대표번호 </strong></td>
	  ...
	  <tr>
	    ...
	    <td width="106" bgcolor="#FFFFFF" style="padding-right:5 ">
		  <select name="huntType" style="width:120 " class="select01">
	        <option <%if("1".equals(hunt)){%> selected <%}%> value="1">순차 착신</option>
			<option <%if("2".equals(hunt)){%> selected <%}%> value="2">고정 착신</option>
			<option <%if("3".equals(hunt)){%> selected <%}%> value="3">자동 착신</option>
			<option <%if("4".equals(hunt)){%> selected <%}%> value="4">동시 착신</option>
	      </select>
		</td>
	    <td colspan="2" bgcolor="#FFFFFF"></td>
	    <td width="10">&nbsp;</td>
	...
	<!-- ########################################## -->
	  ...
	  <tr>
	    ...
	    <td colspan="4" bgcolor="#FFFFFF" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	      <%if(b>0){%>
	          <input name="standChk" type="checkbox" style="width:12" checked> <strong>무응답시 예외처리 </strong>&nbsp;<br>
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;대기시간&nbsp;
	    ...
	    <td width="106" bgcolor="#FFFFFF" style="padding-right:5 ">
		  <%if(huntConstraintType>0){%>
			  <select name="exceptType" style="width:170 " class="select01" onChange="exceptChange2()">
		        <option <%if(prefixTypeVal==0){%> selected <%}%> value="0">호종료</option>
		        <%-- <option <%if(prefixTypeVal==1){%> selected <%}%> value="1">정해진 루트 호중계</option> --%>
				<option <%if(prefixTypeVal==3){%> selected <%}%> value="3">정해진 전화번호로 호중계</option>
				<%-- <option <%if(prefixTypeVal==4){%> selected <%}%> value="4">통화중 호대기</option> --%>
		      </select>
		  <%}else{%>
			  <select name="exceptType" style="width:170 " class="select01" onChange="exceptChange2()">
	...
	<%}else if(prefixTypeVal==4){%>
	  ...
	  <tr>
	    <td width="10" height="30">&nbsp;</td>
	    <td colspan="4" bgcolor="#FFFFFF" style="padding-right:5">
	    	<div id="div6" name="div6" style="position:absolute; left:15px; top:340px; width:380; overflow:hidden; ">&nbsp;&nbsp;&nbsp;대기 안내음&nbsp;&nbsp;&nbsp;<FONT color="blue"><%=strartFile%></FONT></div>
	    </td>
	    <td width="10">&nbsp;</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td width="10" height="30">&nbsp;</td>
	    <td colspan="4" bgcolor="#FFFFFF" style="padding-right:5">
	    	<div id="div8" name="div8" style="position:absolute; left:15px; top:385px; width:380; overflow:hidden; ">&nbsp;&nbsp;&nbsp;대기 종료음&nbsp;&nbsp;&nbsp;<FONT color="blue"><%=endFile%></FONT></div>
	    </td>
	    <td width="10">&nbsp;</td>
	  </tr>
	  <tr>
