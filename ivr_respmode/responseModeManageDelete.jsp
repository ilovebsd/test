...
// 	String strNwuIdx = (String)request.getAttribute("nwuIdx");
...
<body>
<%-- <form name="delForm" action="<%=StaticString.ContextRoot%>/responseModeManageDelete.do2" method="post"> --%>
<form name="delForm" method="post">
<%-- <input type="hidden" name="scCode" value="<%=strScCode%>"> --%>
<%-- <input type="hidden" name="nwuIdx" value="<%=strNwuIdx%>"> --%>
...
<table width="200" border="0" cellpadding="0" cellspacing="0" bgcolor="#F3F9F5">
	...
	<tr height="30">
		...
		<table width="200" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td width="10"></td>
				<td><span style="font-family:Gulim;font-size:12px;font-weight:bold;color:rgb(255,255,255);">응답모드삭제</span></td>
		...
		<table width="200" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="right"><img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif");' style="CURSOR:hand;"  width="40" height="20" 
					onClick="goDeletePro();<!-- del(); -->"></td>
				<td width="6"></td>
				<td align="left"><img src="<%=StaticString.ContextRoot%>/imgs/Content_cancel_n_btn.gif" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_cancel_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_cancel_p_btn.gif");' style="CURSOR:hand;"  width="40" height="20" onClick="hiddenAdCodeDiv();"></td>
			</tr>
		</table>
<%
}else{
%>
		<table width="200" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center"><img src="<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif" onmouseout='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_n_btn.gif");' onmouseover='javascript:fncOverOut(this,"<%=StaticString.ContextRoot%>/imgs/Content_ok_p_btn.gif");' style="CURSOR:hand;"  width="40" height="20" onClick="hiddenAdCodeDiv();"></td>
			</tr>
		</table>
<%
}
